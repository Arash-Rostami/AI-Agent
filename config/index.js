...
export const GEMINI_API_URL_THINKING = process.env.GEMINI_API_URL_THINKING || 'https://generativelanguage.googleapis.com/v1beta/models/gemini-3-pro:generateContent';
