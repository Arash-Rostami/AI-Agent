export default class MessageFormatter {
    ...
    format(text) {
        ...
        // Handle literal newlines if they exist as string literals
        html = html.replace(/\\n/g, '\n');
    ...
    parseCodeBlocks(html) {
        // Use a placeholder to prevent markdown parsing inside code blocks
        const placeholders = [];
    ...
    parseTable(text) {
        // If coming from parseCodeBlocks, text is an object
    ...
    parseListsAndBasicMarkdown(input) {
        ...
        for (const line of lines) {
            // Restore placeholders immediately if line is just a placeholder
